...
所有内联路径与命令以 quant-research-coding 技能根目录/当前项目为基准；纯排版已有结果由 frontend-page-router 负责。
...
| 2 | Daily research helper, repeatable backtest, backtest computation plus review HTML, report-support table | Clear entry point, parameters near the top or in a small config, sanity checks, saved output |
